...
/**
 * Home object for domain model class Contribution.
 * @see com.gafinance.db.Contribution
 * @author Hibernate Tools
 */
public class ContributionHome {

	private static final Log log = LogFactory.getLog(ContributionHome.class);
	...
	public void persist(Contribution transientInstance) {
		log.debug("persisting Contribution instance");
		try {
	...
	public Contribution merge(Contribution detachedInstance) {
		...
		try {
			Contribution result = (Contribution) sessionFactory
	...
	public Contribution findById(java.lang.Integer id) {
		...
		try {
			Contribution instance = (Contribution) sessionFactory
					.getCurrentSession().get("com.gafinance.db.Contribution",
							id);
			if (instance == null) {
	...
	public List findByExample(Contribution instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.gafinance.db.Contribution")
